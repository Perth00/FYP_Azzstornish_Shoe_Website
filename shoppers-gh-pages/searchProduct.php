...
foreach ($cartItems as $item) {
  ...
  if(isset($_POST["se"]))
  {
    $product = $Login->showSearchProduct($title);
  ...
  if(isset($_POST["search"]))
  {
    ...
    $product = $Login->showFilterSearchProduct($women,$men,$children,$red,$green,$blue,$purple,$white,$black,$title,$yellow);
          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="text-black h5" style="margin-bottom: -40px">Shop All (<?php echo  $title ?>)</h2></div>
