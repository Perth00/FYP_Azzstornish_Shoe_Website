               ...
               <div class="sidebar_blog_1">
                  <div class="sidebar-header">
                     <div class="logo_section">
                        <a href="profile.php"><img class="logo_icon img-responsive" src="images/logo/logo_black.jpeg" alt="#" /></a>
                     </div>
                  </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                       <div class="full dis_flex center_text">
                                          <div class="profile_img"><img width="180" class="rounded-circle" src="../Admin/image/user/<?php echo $user["Image"]?>" alt="#" /></div>
                                          <div class="profile_contant">
                                             <div class="contact_inner">
                                                <h3><?php echo $user["Name"]; ?><?php echo " ";?></h3>
