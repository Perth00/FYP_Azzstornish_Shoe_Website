...
if (isset($_POST["submit"])) {
   ...
   if (empty($percentErr) && empty($offerErr) ) {
       // Update the user data in the database without handling image
       $Login->addDiscount( $offer, $percentage, $userID,$available,$date);
   }
                           ...
                           <div class="white_shd full margin_bottom_30">
                              ...
                              <div class="full price_table padding_infor_info">
                                 <div class="row">
                                    ...
                                    <!-- profile image -->
                                    <form action="addDiscount.php" method="post" enctype="multipart/form-data">
                                    <div class="col-lg-12">
                                       <div class="full dis_flex center_text">
                                          ...
                                          <div class="profile_contant">
                                            ...
                                            <br><label for="userID">userID</label><br>
                                             ...
                                             <input type="date" name="date" require><br>
