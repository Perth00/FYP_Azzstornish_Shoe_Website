...
$men=$Login->showStatisticProductCategoryMen();
$women=$Login->showStatisticProductCategoryWomen();
$children=$Login->showStatisticProductCategoryChildren();

$qty=$Login->showStatisticProductQty();
$series=$Login->showStatisticSeries();
